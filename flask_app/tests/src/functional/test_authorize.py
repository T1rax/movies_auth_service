...
@pytest.mark.asyncio
async def test_authorize(test_config, payload, expected_answer, default_headers, aiohttp_session, db_client, mds_client):
    ...
    response_2 = await aiohttp_session.post(test_config.service_url+'/auth/v1/authorize', cookies=cookies_dict_1, headers=default_headers)
